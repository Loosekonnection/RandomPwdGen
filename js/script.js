...
function generatePassword() {
    ...
    if (pwdLength >= 8 && pwdLength <= 128) {
        ...
        var numChoice = confirm("Click OK if you would like the password to contain: Numbers?");
        var lcChoice = confirm("Click OK if you would like the password to contain: Lowercase Letters?");
        var ucChoice = confirm("Click OK if you would like the password to contain: Uppercase Letters?");
        var splChoice = confirm("Click OK if you would like the password to contain: Special Characters?");
